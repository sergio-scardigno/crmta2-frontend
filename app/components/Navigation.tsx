          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:block text-sm text-neutral-400">
                <span className="font-medium text-emerald-400">Admin: {admin?.username}</span>
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <div className="hidden sm:block text-sm text-neutral-400">
              <span className="font-medium text-emerald-400">{currentTenant}</span>
            </div>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="pt-4 pb-2 space-y-2 border-t border-neutral-700 mt-2">
                <div className="px-3 py-2 text-sm text-neutral-400">
                  Empresa: <span className="font-medium text-emerald-400">{currentTenant}</span>
                </div>
                {isAdmin && (
                  <div className="px-3 py-2 text-sm text-neutral-400">
                    Admin: <span className="font-medium text-emerald-400">{admin?.username}</span>
                  </div>
                )}
                {isAdmin && (
                  <Link
